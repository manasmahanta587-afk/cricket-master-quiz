...
import type { Difficulty as _Difficulty, Question as _Question, QuestionId as _QuestionId, UserProfilePublic as _UserProfilePublic } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async awardQuizCoins(arg0: UserId, arg1: Coins): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.awardQuizCoins(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async checkAnswer(arg0: QuestionId, arg1: bigint, arg2: bigint): Promise<AnswerResult> {
        if (this.processError) {
            try {
                const result = await this.actor.checkAnswer(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuestions(arg0: Difficulty): Promise<Array<Question>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuestions(to_candid_Difficulty_n2(this._uploadFile, this._downloadFile, arg0));
    ...
    async loginOrRegister(arg0: UserId): Promise<LoginResult> {
        if (this.processError) {
            try {
                const result = await this.actor.loginOrRegister(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
